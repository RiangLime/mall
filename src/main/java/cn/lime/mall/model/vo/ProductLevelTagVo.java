...
@NoArgsConstructor
@AllArgsConstructor
public class ProductLevelTagVo implements Serializable {
    /**
     * 商品分类ID
     */
    ...
    @Schema(description = "该节点下的二级子节点")
    private List<ProductLevelTagVo> children;

    public static ProductLevelTagVo fromBean(ProductTag bean){
        ProductLevelTagVo vo = new ProductLevelTagVo();
