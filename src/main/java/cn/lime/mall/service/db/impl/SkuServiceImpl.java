...
public class SkuServiceImpl extends ServiceImpl<SkuMapper, Sku>
    ...
    public Sku addSku(SkuInfo skuInfo, Long productId) {
        ...
        sku.setReserveIntA(sku.getReserveIntA());
        sku.setReserveIntB(sku.getReserveIntB());
        sku.setReserveStrA(sku.getReserveStrA());
        sku.setReserveStrB(sku.getReserveStrB());
    ...
    @Override
    public boolean updateSkuPriceStock(Long skuId, String skuCode, Integer price, Integer stock, String skuDescription,
                                       String remark, Integer reIntA, Integer reIntB, String reStrA, String reStrB) {
        ...
        if (StringUtils.isNotEmpty(reStrA)) wrapper.set(Sku::getReserveStrA,reStrA);
        if (StringUtils.isNotEmpty(reStrB)) wrapper.set(Sku::getReserveStrB,reStrB);
        if (ObjectUtils.isNotEmpty(reIntA)) wrapper.set(Sku::getReserveIntA,reIntA);
        if (ObjectUtils.isNotEmpty(reIntB)) wrapper.set(Sku::getReserveIntB,reIntB);
